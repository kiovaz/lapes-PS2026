...
export class AuthController {
    ...
    @ApiResponse({ status: 201, description: 'Customer registrado com sucesso (retorna o token JWT).' })
    ...
    @ApiResponse({ status: 200, description: 'Login efetuado com sucesso (retorna o token JWT).' })
    ...
    @ApiResponse({ status: 200, description: 'Perfil retornado com sucesso (sem a senha).' })
